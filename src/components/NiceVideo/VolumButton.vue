<template>
    <div style="position: relative;">
        ...
        <div @mouseenter="toShowVolumControl" @mouseleave="tryTocloseVolumControl" style="height: 100%; width: 100%;">
            <svg t="1716018651878" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                p-id="2638" width="100%" height="100%">
                <path
...
function changeVolum(e: MouseEvent) {
    const start = e.clientY
    const currentV = volum.value
...
.thumb {
    ...
    margin-left: -3px;
    cursor: pointer;
    transform: translateY(v-bind('volum + "px"'));
}
</style>